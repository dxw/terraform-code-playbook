---
title: Contributing to the Terraform Code Playbook
related_order: 999999999999
---

The Terraform Code Playbook is public and anyone, inside or outside of dxw, can
suggest changes to it. This means you!
...
repository is available at <https://github.com/dxw/terraform-code-playbook>
...
[GitHub Pull Requests page](https://github.com/dxw/terraform-code-playbook/pulls).
After a few minutes, you should be able to view a preview of the Playbook with your 
changes by clicking on the URL next to '😎 Browse the preview'
